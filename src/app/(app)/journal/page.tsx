    ...
    <div className="pt-4 pb-6">
      ...
      <div className="flex items-center justify-between px-6 pt-2 pb-5">
        ...
        <Link href="/journal/new"
          className="flex items-center gap-1.5 px-4 py-2 rounded-full text-[11px] font-[600] tracking-[0.08em] uppercase"
            ...
            <Link key={reading.id} href={`/journal/${reading.id}`}
              ...
              <div className="relative">
                <div className="flex items-start justify-between gap-2 mb-1">
                  <h3 className="text-[16px] leading-tight flex-1"
                    style={{ fontFamily: "var(--font-marcellus)", color: "#EAF0F8" }}>
                    {reading.title}
                  </h3>
                ...
                {reading.notes && (
                  <p className="text-[12px] italic line-clamp-2 mb-2"
